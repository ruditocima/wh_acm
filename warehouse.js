...
function renderTable(section, searchQuery = '') {
    ...
    if (data.length > 0) {
        ...
        if (section === 'transaksi') {
            ...
            keys = ['Periode', 'Type', 'Region', 'Kode Project', 'No PR-PO', 'Nama Project', 'PO Plan', 'PO Final', 'Status PO', 'Permit', 'Civil Work', 'Status SND', 'Status Doc', ...keys.filter(k => !['Periode', 'Type', 'Region', 'Kode Project', 'No PR-PO', 'Nama Project', 'PO Plan', 'PO Final', 'Status PO', 'Permit', 'Civil Work', 'Status SND', 'Status Doc'].includes(k))];
        }
        ...
        else if(section === 'project') defaultKeys = ["Periode", "Type", "Region", "Kode Project", "No PR-PO", "Nama Project", "PO Plan", "PO Final", "Status PO", "Permit", "Civil Work", "Status SND", "Status Doc"];
...
function openModal(index) {
    ...
    if (currentSection === 'barang') {
        ...
        keys = ['Periode', 'Type', 'Region', 'Kode Project', 'No PR-PO', 'Nama Project', 'PO Plan', 'PO Final', 'Status PO', 'Permit', 'Civil Work', 'Status SND', 'Status Doc'];
